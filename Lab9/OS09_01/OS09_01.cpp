...
int main()
{
    ...
    printFileInfo((LPWSTR)L"D:\\Education\\3 курс 2 сем\\OS\\Lab9\\OS09_01.txt");
    printFileTxt((LPWSTR)L"D:\\Education\\3 курс 2 сем\\OS\\Lab9\\OS09_01.txt");
    system("pause");
}

BOOL printFileInfo(LPWSTR FileName) //выводит информацию о файле в стандартный поток вывода if true = успешно выполнено else if false = error
{
